...
export const ROLE_NAV: Record<Role, NavItem[]> = {
  Supervisor: [
    ...
    { to: "/registers", label: "Registers", icon: "Users" },
    { section: "Progress" },
    ...
    { to: "/inventory-portal/supervisor", label: "Inventory Portal", icon: "Package" },
  ...
  Administrator: [
    ...
    { to: "/inventory-portal", label: "Inventory Portal", icon: "Package" },
