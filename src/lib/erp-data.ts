...
export const ROLE_NAV: Record<Role, NavRoute[]> = {
  Supervisor: [
    ...
    { to: "/medical-equipment", label: "Medical Equipment", icon: "HeartPulse" },
    { to: "/aerb-compliance", label: "AERB & Radiation", icon: "Radiation" },
    { to: "/cleanroom-validation", label: "Cleanroom & HVAC", icon: "Wind" },
    { to: "/medical-gas", label: "Medical Gas", icon: "Flame" },
    { to: "/nabh-checklist", label: "NABH Checklist", icon: "ClipboardCheck" },
    { to: "/reports", label: "Reports", icon: "BarChart3" },
    { to: "/daily-diary", label: "Daily Diary", icon: "Calendar" },
    { to: "/approvals-delegation", label: "Delegation & SLA", icon: "ArrowUpCircle" },
  ...
  Administrator: [
    ...
    { to: "/approvals-delegation", label: "Delegation & SLA", icon: "ArrowUpCircle" },
    { to: "/digital-twin", label: "Digital Twin", icon: "Box" },
    { to: "/anomaly-detection", label: "AI Anomaly Detection", icon: "Brain" },
    ...
    { to: "/data-export", label: "Data Export", icon: "Database" },
  ...
  A1: [
    ...
    { to: "/backup-verification", label: "Backup Verification", icon: "Database" },
